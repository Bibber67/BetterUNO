...
export class GameService {
  ...
  /*
   * Bereits gespeichertes Spiel
   * wieder in den GameService laden.
   */
  ...
  private getCurrentPlayerInGame(
    game: Game
  ): Player {
